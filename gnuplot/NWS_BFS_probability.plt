...
####### 出力ファイル名 ########
set output '/Users/Hideo/Documents/篠宮研究室/simulator/LeaderElection/gnuplot/figure/NWS_BFS_probability.eps'
...
plot "csv/NWS_BFS_SharedVertex_prob.csv" using 1:2 w lp lc 3 pt 5 ps 1.5 dt 1 title "SharedVertex","csv/NWS_BFS_Centroid_prob.csv" using 1:2 w lp lc 2 pt 7 ps 1.5 dt 3 title "Centroid", "csv/NWS_BFS_OPT_prob.csv" using 1:2 w lp lc 2 pt 9 ps 1.5 dt 3 title "OPT"
